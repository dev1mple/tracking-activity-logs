...
if (isset($_POST['insertNewBranchBtn'])) {
	...
	if (!empty($address) && !empty($employee) && !empty($contact_number)) {
		$insertABranch = insertABranch($pdo, $address, $employee, 
...
if (isset($_POST['updateBranchBtn'])) {
	...
	if (!empty($address) && !empty($employee) && !empty($contact_number)) {
		...
		$updateBranch = updateBranch($pdo, $address, $employee, $contact_number, 
